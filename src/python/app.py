...
def prices_timeseries(symbol, start, end):
    ...
    df = get_historical_data(symbol, start, end, output_format='pandas',token='sk_f586537e19ab467695dfe3fbe452c928')
...
def prices_metrics(symbol, date):
    ...
    prices = get_historical_data(symbol, date, date, output_format='pandas',token='sk_f586537e19ab467695dfe3fbe452c928')
...
def returns_timeseries(symbol, start, end):
    ...
    df = get_historical_data(symbol, previous_day, end, output_format='pandas',token='sk_f586537e19ab467695dfe3fbe452c928')
